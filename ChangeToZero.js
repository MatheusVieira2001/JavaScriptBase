//bootcamp digital innovation one (Substitui numeros pares por 0)

function substituiNumerosPares(array) {
    if (!array) return console.log("array invalido");
    if (!array.length) return console.log("array invalido");
